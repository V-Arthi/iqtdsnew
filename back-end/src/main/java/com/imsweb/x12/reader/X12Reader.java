...
public class X12Reader {
    ...
    private static final String _X186_ANSI_VERSION = "005010";
    private static final String _X286_ANSI_VERSION = "005010";
    private static final String _X358_ANSI_VERSION = "004010";
    private static final String _TA1_ANSI_VERSION = "000";
    private static final String _999_ANSI_VERSION = "005010X231A1";
    private static final String _270_ANSI_VERSION = "004010X092A1";
    private static final String _271_ANSI_VERSION = "004010X092A1";
    private static final String _276_ANSI_VERSION = "004010X093A1";
    private static final String _277_ANSI_VERSION = "005010X212";
    private static final String _278N_ANSI_VERSION = "005010X216";
    ...
    public enum FileType {
    	ANSI824_5010_X186("mapping/824.5010.X186.A1.xml"),
    	ANSI827_5010_X286("mapping/827.5010.X286.xml"),
    	...
    	ANSI855_4010_X358("mapping/855.4010.X358.xml"),
    	ANSITA1_5010("mapping/TA1.5010.xml"),
    	ANSI999_5010("mapping/999.5010.xml"),
    	ANSI270_4010_X092("mapping/270.4010.X092.A1.xml"),
    	ANSI271_4010_X092("mapping/271.4010.X092.A1.xml"),
    	ANSI276_4010_X093("mapping/276.4010.X093.A1.xml"),
    	ANSI277_5010_X212("mapping/277.5010.X212.xml"),
    	ANSI278N_5010_X216("mapping/278N.5010.X216.xml");
    ...
    static {
        ...
        _TYPES.put(FileType.ANSI824_5010_X186, _X186_ANSI_VERSION);
        _TYPES.put(FileType.ANSI827_5010_X286, _X286_ANSI_VERSION);
        _TYPES.put(FileType.ANSI855_4010_X358, _X358_ANSI_VERSION);
        _TYPES.put(FileType.ANSITA1_5010, _TA1_ANSI_VERSION);
        _TYPES.put(FileType.ANSI999_5010, _999_ANSI_VERSION);
        _TYPES.put(FileType.ANSI270_4010_X092, _270_ANSI_VERSION);
        _TYPES.put(FileType.ANSI271_4010_X092, _271_ANSI_VERSION);
        _TYPES.put(FileType.ANSI276_4010_X093, _276_ANSI_VERSION);
        _TYPES.put(FileType.ANSI277_5010_X212, _277_ANSI_VERSION);
        _TYPES.put(FileType.ANSI278N_5010_X216, _278N_ANSI_VERSION);
    ...
    private String storeData(String currentLoopId, List<String> loopLines, String prevousLoopId, Separators separators) {
        ...
        if (_dataLoop.getLoops().size() == 0) // if no child loops have been stored yet.
            ...
            if (!_dataLoop.getLoop(primaryIndex).getLoop(secondaryIndex).getId().equals(parentName)) { //if the parent loop of the loop we want to create is NOT the second loop in the path
            	...
            	}catch(NullPointerException e) {//Arun
            		//Do nothing - Lets see
            		_errors.add("Some null pointers - Not handled. Ignored as such risk of data issues");
            	}
            }
